				...
				<div class="span3">
		          ...
		          <aside class="well sidebar-nav">
		          	...
		          	<ul class='nav nav-list'>
		    			...
		    			<li> <a href='<?=base_url();?>index.php/chofer-vendedor/clientes/crearVenta'>Crear venta</a></li>
		    			<li> <a href='<?=base_url();?>index.php/chofer-vendedor/clientes/modificarVenta'>Modificar venta</a></li>
		    			<li> <a href='<?=base_url();?>index.php/chofer-vendedor/clientes/cancelarVenta'>Cancelar</a></li>
		    		</ul>
		          </aside>
		          <!--Fin sidebar-->
		        </div>
