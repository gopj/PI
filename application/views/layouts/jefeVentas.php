...
<html>
	...
	<body>
		...
		<div class="navbar">
            ...
            <div class='navbar-inner'>
				<ul class='nav pull-right'>
					<li> <a href='<?=base_url();?>jefeVentas/rutas'>Rutas</a></li>
					<li> <a href='<?=base_url();?>jefeVentas/roles'>Roles</a></li>
					<li> <a href='<?=base_url();?>jefeVentas/clienteRol'>Asignar Clientes a un rol</a></li>
